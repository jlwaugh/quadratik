...
const connectProviderToApp = async (provider, directLogin, dispatch) => {
  try {
    ...
    console.error('Error connecting web3 provider to app', error);
...
export default connectProviderToApp;